  ...
  const TRANSLATIONS = {
    es: {
      ...
      hermesDemo: {
        ...
        fallback: 'No tengo información específica sobre eso, pero puedo contarte sobre:<br><br>• <strong>Byte Wizzard</strong> — qué es el estudio<br>• <strong>Luna</strong> — AI Business Assistant<br>• <strong>Hermes</strong> — Demo Bot del estudio<br>• <strong>Courier TMS</strong> — Logistics Intelligence<br>• <strong>RolePlay Chat</strong> — Call Center Digital<br>• <strong>ClipCraft</strong> — Content Creation<br>• <strong>Profe Mágico</strong> — AI Learning<br>• <strong>Stack</strong> — tecnologías que usamos<br>• <strong>Visión</strong> — nuestro enfoque<br><br>¿Sobre qué querés saber?',
        suggestions: ['¿Qué es Byte Wizzard?', 'Contame sobre Courier TMS', '¿Qué stack usan?', '¿Qué es RolePlay Chat?'],
        kb: [
          ...
          { id: 'roleplay', keywords: ['roleplay', 'role play', 'roleplay chat', 'call center', 'simulación', 'simulacion', 'digital', 'postulantes', 'entrenamiento'], label: 'RolePlay Chat', response: '<strong>RolePlay Chat</strong> — Call Center Digital Simulation<br><br>Simulador de interacción digital para call centers.<br><br><strong>Escenarios:</strong><br>• Reclamo por pedido<br>• Soporte técnico<br>• Consulta de facturación<br>• Venta consultiva<br>• Interacción WhatsApp<br><br><em>Estado: demo interactiva.</em>' },
          ...
          { id: 'clipcraft', keywords: ['clipcraft', 'clip', 'craft', 'content', 'contenido', 'multimedia', 'video', 'foto', 'edición', 'mobile', 'creación'], label: 'ClipCraft', response: '<strong>ClipCraft</strong> — Content Creation Platform<br><br>App móvil para creación de contenido multimedia.<br><br><strong>Funciones planeadas:</strong><br>• Edición de fotos y videos<br>• Generación automática de videos<br>• Música integrada<br>• Render en la nube<br>• Exportación directa al dispositivo<br><br><em>Estado: proyecto futuro — MVP interno en desarrollo.</em>' },
    ...
    en: {
      ...
      hermesDemo: {
        ...
        fallback: 'I don\'t have specific info about that, but I can tell you about:<br><br>• <strong>Byte Wizzard</strong> — what the studio is<br>• <strong>Luna</strong> — AI Business Assistant<br>• <strong>Hermes</strong> — Studio Demo Bot<br>• <strong>Courier TMS</strong> — Logistics Intelligence<br>• <strong>RolePlay Chat</strong> — Call Center Digital<br>• <strong>ClipCraft</strong> — Content Creation<br>• <strong>Profe Mágico</strong> — AI Learning<br>• <strong>Stack</strong> — our technology stack<br>• <strong>Vision</strong> — our approach<br><br>What would you like to know?',
        suggestions: ['What is Byte Wizzard?', 'Tell me about Courier TMS', 'What stack do you use?', 'What is RolePlay Chat?'],
        kb: [
          ...
          { id: 'roleplay', keywords: ['roleplay', 'role play', 'roleplay chat', 'call center', 'simulation', 'digital', 'candidates', 'training'], label: 'RolePlay Chat', response: '<strong>RolePlay Chat</strong> — Call Center Digital Simulation<br><br>Digital interaction simulator for call centers.<br><br><strong>Scenarios:</strong><br>• Order claim<br>• Technical support<br>• Billing inquiry<br>• Consultative sales<br>• WhatsApp interaction<br><br><em>Status: interactive demo.</em>' },
