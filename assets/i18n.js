      ...
      products: {
        ...
        profe: {
          ...
          OmniConnect: {
            ...
            features: ['19 KPIs modelados desde Dengo', '3 perfiles: Admin, Supervisor, Operador', 'Dashboards en tiempo real con WebSocket', 'Gestión omnicanal (WhatsApp, email, phone)', 'Autenticación JWT + roles RBAC', 'Validación de entrada, paginación, rate limiting', 'Cache inteligente con invalidación por WebSocket', 'Timeouts configurables + slow query logging', 'Backup automático SQLite con retención', 'Despliegue: Docker, PM2 o systemd'],
            status: 'EN DESARROLLO',
      ...
      products: {
        ...
        profe: {
          ...
          OmniConnect: {
            ...
            name: 'OmniConnect',
            tagline: 'Call Center Intelligence Platform',
            features: ['19 KPIs modelados do Dengo', '3 perfis: Admin, Supervisor, Operador', 'Dashboards em tempo real com WebSocket', 'Gestão omnicanal (WhatsApp, email, phone)', 'Autenticação JWT + roles RBAC', 'Validação de entrada, paginação, rate limiting', 'Cache inteligente com invalidação por WebSocket', 'Timeouts configuráveis + slow query logging', 'Backup automático SQLite com retenção', 'Deploy: Docker, PM2 ou systemd'],
            status: 'EM DESENVOLVIMENTO',
            link: 'Node.js · Express · SQLite WAL · WebSocket · JWT',
          },
      },
